...
# --- Remove any duplicate columns ending with ".1" ---
df = df[[col for col in df.columns if not col.endswith(".1")]]

# === Manual list of European countries ===
european_countries = [
...
url = "https://ourworldindata.org/grapher/energy-consumption-by-source-and-country.csv?v=1&csvType=full&useColumnShortNames=true"
...
# --- Remove duplicate columns ending with ".1" FIRST ---
df = df[[col for col in df.columns if not col.endswith(".1")]]
